...
tpl_resource_target_ptrn = '{}/{}.py'            # where to write the generated class files to, with one placeholder for the class name

# Whether and where to put the factory methods
write_factory = True
tpl_factory_target = '{}/fhirelementfactory.py'

# Whether and where to write unit tests
write_unittests = True
tpl_unittest_target_ptrn = '{}/{}_tests.py'     # a pattern to determine the output files for unit tests; the one placeholder will be the class name
...
tpl_searchparams_target = '{}/fhirsearchelement.py'
