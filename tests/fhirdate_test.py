...
from models.fhirdatetime import FHIRDateTime
from models.fhirinstant import FHIRInstant
from models.fhirtime import FHIRTime
...
class TestFHIRDate(unittest.TestCase):
    ...
    def test_datetime(self):
        ...
        # Check that we also correctly provide the datetime property
        self.assertIsInstance(FHIRDateTime("2015").datetime, datetime.datetime)
        self.assertIsInstance(FHIRDateTime("2015-02-07").datetime, datetime.datetime)
        self.assertIsInstance(FHIRDateTime("2015-02-07T13:28:17Z").datetime, datetime.datetime)
    ...
    def test_instant(self):
        ...
        # Check that we also correctly provide the datetime property
        self.assertIsInstance(FHIRInstant("2015-02-07T13:28:17Z").datetime, datetime.datetime)
    ...
    def test_time(self):
        ...
        # Check that we also correctly provide the time property
        self.assertIsInstance(FHIRTime("13:28:17").time, datetime.time)
