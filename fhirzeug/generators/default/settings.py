...
tpl_dependencies_source = (
    "template-dependencies.json"  # template used to render the JSON dependency graph
)
...
resource_modules_lowercase = (
    True  # whether all resource paths (i.e. modules) should be lowercase
)
...
backbone_class_adds_parent = (
    True  # if True, backbone class names prepend their parent's class name
)
